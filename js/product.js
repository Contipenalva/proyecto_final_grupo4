  ...
  (product) =>
    `       
      <div >
          ...
          <button class='btn btncardcarrito' onclick="addCart(${product.id})">Añadir Carrito</button>
          
          <button class='btn btncardfavorito' onclick="addFavorite(${product.id})">Añadir Favoritos</button>
          </div>
          </div>
      </div>
...
//                ${userExist ? // Verificar si el usuario está logeado
//                  `
